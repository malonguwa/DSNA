...
public class Clustering extends JApplet {
...
//	Factory<Graph<Integer,Number>> graphFactory;
	...
	private void setUpView(Graph graph) throws IOException {
        ...
        final AggregateLayout<Integer,Number> layout = 
        	new AggregateLayout<Integer,Number>(new FRLayout<Integer,Number>(graph));
